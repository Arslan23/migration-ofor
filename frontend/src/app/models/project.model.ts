import { ZoneIntervention } from "./geo.model";
import { AffectationPersonnel } from "./personnel.model";
...
export type { ZoneIntervention } from "./geo.model";
export type { AffectationPersonnel, Personnel, RoleProjet } from "./personnel.model";
...
export interface Project {
    ...
    activities: Activity[];
    workflowStatus?: "brouillon" | "en_validation" | "valide" | "rejete";
    createdAt: string;
    updatedAt: string;
}
