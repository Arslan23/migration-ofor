...
import { getServiceById } from "./entites-execution.data";
import { getOperationById } from "./operations.data";
  ...
  const items: Item[] = [
    {
      ...
      nature: "Formation",
      description: `Programme transversal de renforcement des capacités du personnel — ex. ${year}`,
    },
    {
    ...
    },
    {
      ...
      nature: "Maintenance",
      description: `Maintenance préventive trimestrielle du parc — ex. ${year}`,
    },
    {
