...
export interface PTADeliverable {
  ...
  targetValue: number;
  currentValue?: number;
  // Cibles trimestrielles (la somme doit idéalement égaler targetValue)
  targetT1?: number;
  targetT2?: number;
  targetT3?: number;
  targetT4?: number;
...
export interface PTAActivity {
  ...
  // Rattachement opération (mutuellement exclusif avec projectId/activityId)
  operationId?: string;
