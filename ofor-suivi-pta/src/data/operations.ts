// Opérations rattachées aux services (entités d'exécution).
// Une opération est une activité institutionnelle récurrente d'un service
// (ex: "Audit interne semestriel", "Plan de formation"), distincte d'un projet.
// Dans la planification PTA, chaque activité PTA est rattachée soit à
// une activité d'un projet, soit à une opération d'un service (mutuellement exclusif).
